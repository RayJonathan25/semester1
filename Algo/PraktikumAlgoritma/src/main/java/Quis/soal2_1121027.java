...
public class soal2_1121027 {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 1; i <= lamaKerja; i++) {
      ...
      if (i == 1) {
        akumulasiGajiTahunan2 = totalGajiSetahun * 1;
      } else if (i > 1) {
      ...
      if (totalGajiSetahunDikurangiPTKP <= 50000000) {
        ...
        totalGajiSetahunDikurangiPTKP <= 250000000 &&
        totalGajiSetahunDikurangiPTKP <= 50000000
      ) {
        proses1 = (int) (totalGajiSetahunDikurangiPTKP * 0.05);
        ...
        totalGajiSetahunDikurangiPTKP <= 500000000 &&
        totalGajiSetahunDikurangiPTKP <= 250000000
      ) {
        proses1 = (int) (totalGajiSetahunDikurangiPTKP * 0.05);
        proses2 = (int) (proses1 * 0.15);
